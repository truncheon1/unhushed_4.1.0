...
class CreateMsClassRegistrationsTable extends Migration
{
    public function up()
    {
        Schema::create('ms_class_registrations', function (Blueprint $table) {
            $table->id();
            //student
    ...
    {
        Schema::dropIfExists('ms_class_registrations');
    }
}

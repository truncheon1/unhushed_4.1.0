...
<section>
    ...
    <div class="crumbBar">
        <div class="breadcrumbs">
            ...
            <span style="font-weight: bold;color:#9acd57">Pedagogy</span>
        </div>
    </div>
        ...
        <div id="headerBar" class="headerBar col-lg-8 col-md-12 px-5 mx-auto">
            <div class="row">
                <div class="col-1 m-auto">
                    <img src="{{ asset('img/octos/ollie-ped.png') }}" alt="Ollie the octopus holding cogs" style="max-width:160px">
                </div>
                <div class="col-8 m-auto">
                    <p class="diazo" style="padding-top:5px;">Pedagogical Citations</p>
        ...
        <div class="row justify-content-center mx-auto pb-5">
            ...
            <div id="search" class="search">
                <div class="pr-4 mx-auto">
                    <form action="{{ url($path.'/pedagogy') }}" method="GET" role="search">
                        <div class="input-group mb-3">
                            ...
                            <div class="input-group-append">
                                ...
                                <a href="{{ url($path.'/pedagogy') }}" button class="btn btn-secondary" type="button" title="Refresh page">

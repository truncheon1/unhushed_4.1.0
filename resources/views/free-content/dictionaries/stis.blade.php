        ...
        <div class="d-flex">
            <div class="row">
                <div class="col-auto mx-auto">
                    <img src="{{ asset('img/cards-med/sti.png') }}" alt="Ollie the octopus holding a book." style="max-width:100px">
                </div>
                <div class="col-auto px-1 mx-auto">
                    <p class="diazo" style="font-size=18px">Sex Ed STIs Dictionary</p>

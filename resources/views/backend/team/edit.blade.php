...
<section>
    ...
    <div class="containerLMS">
                ...
                <div class="col-12">
                    <div class="card" style="width: 50rem">
                        <div class="card-header container-fluid">
                            <div class="row">
                                <div class="col-md-10">EDIT TEAM MEMBER</div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{url($path.'/backend/team')}}" method="POST" id="edit_member" role="form" onsubmit="return editMember()">
                                <input type="hidden" name="id" value="{{$member->id}}" />
                                @csrf
                                <div class="form-row">
                                    <div class="form-group col-md-5">
                                    <label for="first">First</label>
                                    <input id="first" type="text" class="form-control" name="first" value="{{$member->first}}">
                                    </div>
                                    <div class="form-group col-md-7">
                                    <label for="last">Last, Credintials</label>
                                    <input id="last" type="text" class="form-control" name="last" value="{{$member->last}}">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                    <label for="title">Title</label>
                                    <input id="title" type="text" class="form-control" name="title" value="{{$member->title}}">
                                    </div>
                                    <div class="form-group col-md-6">
                                    <label for="dept">Department</label>
                                    <input id="dept" type="text" class="form-control" name="dept" value="{{$member->dept}}">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                    <label for="tags">AC Tags</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="slug" type="text" class="form-control" name="slug" value="{{$member->slug}}">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                    <label for="tags">Bio</label>
                                        <textarea class="form-control teditor" name="bio" id="bio">{{$member->bio}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2 col-form-label ">Headshot</label>
                                    <div class="col-md-10">
                                        <input type="hidden" name="file" class="file-name1" value="{{$member->image}}" />
                                        <div id='imageUploadWide1' class='needsclick'>
                                            <div class='upload-img1 needsclick'>
                                                <div class="dz-image">
                                                    <img src='{{ url('/uploads/team/'.$member->image) }}'/>
                                                </div>
                                                <br/>
                                            </div>
        ...
        <script type="text/javascript">
            ...
            function editMember(){
                let _url = $("#edit_member").attr('action');
                fd = $("#edit_member").serialize();
                $.ajax({
                    url: _url,
                    type: 'patch',
                    data: fd,

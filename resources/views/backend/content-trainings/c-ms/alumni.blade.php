            ...
            <div class="col-8 pb-2">
                <div class="card">
                    <div class="col-12 text-center pt-2">
                        <h3>The Middle School Curriculum (in person)</h3>
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-md-center">
                            <div class="col-8">
                                <ul class="green">Thank you for joining us for our past curricula trainings!
                                    <li class="pl-3">2024, June—Austin, TX</li>
                                    <li class="pl-3">2023, June—Online</li>
                                    <li class="pl-3">2022, July—Austin, TX</li>
                                    <li class="pl-3">2021, July—Online</li>
                                    <li class="pl-3">2020, July—Online</li>
                                    <li class="pl-3">2019, June—Austin, TX</li>
                                    <li class="pl-3">2017, Sept.—Austin, TX</li>
                                    <li class="pl-3">2017, April—Durango, CO</li>
                                </ul>
                            </div>
                        </div>
                    </div>

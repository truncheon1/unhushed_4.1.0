                    ...
                    <div class="card-body">
                        <div class="row mx-5">
                            ...
                            <div class="col-lg-8 col-sm-12 text-justify pr-5">
                                <b><span style="color:#9acd57;font-weight:bold;font-size:16px">Day 4:</span> </b>
                                <p class="text-justify"><span style="font-weight:light;font-size:12px">recorded on Monday June 22nd, 2023.</span>
                                <br></p>
                            </div>
                        </div>
                        <hr>
                        <div class="row mx-5">
                            ...
                            <div class="col">
                                <a href="https://us06web.zoom.us/j/89739565703?pwd=RlZiN3RWZ1RMRzJtanJRSy91Z3QxZz09" target="_blank" class="pr-1">
                                <i class="fas fa-video fa-fw fa-lg align-middle"></i>
                                Zoom: Same for every live session Wed.-Fri.</a>
                            </div>
                            <div class="col-12">&nbsp;</div>
                            <div class="col">

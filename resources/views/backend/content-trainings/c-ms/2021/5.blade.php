        ...
        <div class="row mx-auto">
            <div class="col-8 mx-5">
                <div class="nav-box">
                    ...
                    <a href="{{ url($path.'/middle-school-curriculum-training/4') }}" class="px-1"><i class="fas fa-circle fa-2x fa-fw"></i></a>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4 col-sm-12 text-center align-self-center">
                                <a href="https://drive.google.com/file/d/1uuQCuuj61QNbCuJu9BB21Yv0ezuCAzyt/view?usp=sharing" target="_blank"><img src="/img/trainings/curricula/ms.png" alt="Play Video"></a>
                            </div>
                            <div class="col-lg-8 col-sm-12 text-justify">
                                ...
                                <p class="text-justify"><span style="font-weight:light;font-size:12px">recorded on Monday July 2nd, 2021.</span>
                        ...
                        <div class="row mx-5">
                            ...
                            <div class="col-12">&nbsp;</div>
                            <div class="col">
                                <a href="https://www.facebook.com/groups/themiddleschoolcurriculum" target="_blank" class="pr-1">
                                    <i class="fab fa-facebook-square fa-fw fa-lg align-middle"></i>
                                Quick Link to The Facebook Group - UNHUSHED: The Middle School Curriculum</a>
                            </div>
                            <div class="col-12">&nbsp;</div>
                        </div>
                        <hr>
                        <div class="row px-4">
                            ...
                            <div class="col-11">
                                <a href="https://forms.gle/hehkeH1zvTvPLTzf7" target="_blank" class="pr-1">
                                <i class="fas fa-comment-dots fa-fw fa-lg align-middle"></i>

                    ...
                    <div class="card-body">
                        <div class="row mx-5">
                            ...
                            <div class="col-lg-8 col-sm-12 text-justify pr-5">
                                <b><span style="color:#9acd57;font-weight:bold;font-size:16px">Day 5:</span> Demo Day!</b>
                                <p class="text-justify"><span style="font-weight:light;font-size:12px">Friday Aug 8th 11et/10ct/8pt to 3et/2ct/12pt</span>
                                    <ul class="green pl-4">
                                        <li>Demo's by participants</li>
                                        <li>Feedback</li>
                                        <li>Goodbyes</li>
                                    </ul>
                                </p>

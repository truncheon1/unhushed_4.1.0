                    ...
                    <div class="card-body">
                        <div class="row mx-5">
                            ...
                            <div class="col-lg-8 col-sm-12 text-justify pr-5">
                                ...
                                <p class="text-justify"><span style="font-weight:light;font-size:12px">recorded on Monday June 26th, 2023.</span>
                                <br>Today we went over introductions to your trainer, Karen Rayne, PhD, CSE, and the UN|HUSHED high school curriculum. We navigated the backend of the website 
                                you will use to facilitate the materials. We also introduced participants to one another and discussed unit one.</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row mx-5">
                            ...
                            <div class="col-12">&nbsp;</div>
                            <div class="col">
                                <a href="https://docs.google.com/presentation/d/1wp931pqBkMqA2hy0k8Fxcm-KBaaNTUlDR_Z-zsxgzKE/edit?usp=sharing" target="_blank" class="pr-1">
                        ...
                        <div class="row px-4">
                            ...
                            <div class="col-11">
                                Optional: Review <a href="{{ url($path.'/high-school-curriculum') }}" target="_blank">Unit 1 & 2</a>. We will be going over these Units tomorrow, so if you have time to 

        ...
        <div class="row mx-auto">
            <div class="col-8 mx-5">
                <div class="nav-box">
                    ...
                    <a class="px-1"><i class="fa-solid fa-clock-twelve fa-2x fa-fw"></i></a>
                </div>
            </div>
        </div>
        <div class="row mx-auto">
                    ...
                    <div class="card-body">
                        <div class="row px-4">
                            ...
                            <div class="col-lg-8 col-sm-12 text-justify">
                                <b><span style="color:#9acd57;font-weight:bold;font-size:16px">Session 12:</span> Other Topics and Wrap Up</b>
                                <p class="text-justify"><span style="font-weight:light;font-size:12px">recorded on March 3rd, 2022.</span>
                                <br>Day 12 of the training involves scenarios that draw on legal perspectives from the entire series, adding complexity and layers to the legal framework.
                                We also discuss the difference between the law (a bare minimum) and the sex educator vision (a much higher bar) as an important construct to consider.</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row mx-5">

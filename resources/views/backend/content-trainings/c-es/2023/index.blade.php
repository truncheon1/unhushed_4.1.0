            ...
            <div class="row mx-auto">
                <div class="col-12 mx-5">
                    <div class="nav-box">
                        ...
                        <a href="{{ url($path.'/elementary-school-curriculum-training/1') }}" class="px-1"><i class="fas fa-play-circle fa-2x fa-fw"></i></a>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col text-center">
                                    <img src="{{ asset('img/trainings/curricula/es-Ollie.png') }}" class="responsive" style="max-width:600px;" alt="Ollie the octopus sitting on a green line from the curriculum cover.">
                                    <p style="font-size: 18px">
                                        <br>
                                        Let's get started!
                                        <a href="{{ url($path.'/elementary-school-curriculum-training/1') }}" class="px-1"><i class="fas fa-play-circle fa-2x fa-fw align-middle"></i></a>
                                    </p>
                                </div>
                            </div>
                        </div>

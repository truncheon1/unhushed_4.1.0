        ...
        <div class="row mx-auto">
            <div class="col-8 mx-5">
                <div class="nav-box">
                    ...
                    <a href="{{ url($path.'/elementary-school-curriculum-training/3') }}" class="px-1"><i class="fas fa-circle fa-2x fa-fw"></i></a>
                    <a href="{{ url($path.'/elementary-school-curriculum-training/4') }}" class="px-1"><i class="fas fa-circle fa-2x fa-fw"></i></a>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4 col-sm-12 text-center align-self-center">
                                <a href="#video1" width="200" height="113" data-bs-toggle="modal"><img src="/img/trainings/curricula/es.png" alt="Play Video"></a>
                            </div>
                            <div class="col-lg-8 col-sm-12 text-justify">
                                ...
                                <p class="text-justify"><span style="font-weight:light;font-size:12px">recorded on Friday July 16th, 2021.</span>
                                <br>
                            </div>
                        </div>
                        <hr>

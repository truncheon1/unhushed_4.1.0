                    ...
                    <div class="card-body">
                        <div class="row mx-5">
                            ...
                            <div class="col-lg-8 col-sm-12 text-justify pr-5">
                                ...
                                <p class="text-justify"><span style="font-weight:light;font-size:12px">Tuesday July 29th 11et/10ct/8pt to 3et/2ct/12pt.</span>
                                    <ul class="green pl-4">
                                        <li>Facilitation vs teaching</li>
                                        <li>Anonymous questions</li>
                                        <li>Reviewed Kindergarten & 1st grade materials</li>
                        ...
                        <div class="row mx-5">
                            ...
                            <div class="col-12">&nbsp;</div>
                            <div class="col">
                                <a href="https://docs.google.com/presentation/d/1GZeCVPnvRkVPltWeOK4GY2VqReLttDkqwygBWlDTbQs/edit?usp=sharing" target="_blank" class="pr-1">
                                <i class="fas fa-presentation fa-fw fa-lg align-middle"></i>
                                Facilitator Values</a>
                            </div>
                            <div class="col-12">&nbsp;</div>
                            <div class="col">
                                <a href="https://docs.google.com/document/d/1gqJDP1idPcaKuOay72en4wxe-c2I3yLLglrvtkYwkDs/edit?usp=sharing" target="_blank" class="pr-1">
                                <i class="fas fa-file fa-fw fa-lg align-middle"></i>
                                Things a Teacher Does...</a>
                            </div>
                            <div class="col-12">&nbsp;</div>
                            <div class="col">
                                <a href="https://docs.google.com/presentation/d/1RIVMzst-gFCS-Lmh1OmUzFueXcR58x2a_EBqGTCRh6g/edit?usp=sharing" target="_blank" class="pr-1">
                                <i class="fas fa-presentation fa-fw fa-lg align-middle"></i>
                                Anonymous Questions</a>
                            </div>
                            <div class="col-12">&nbsp;</div>
                            <div class="col">
                                <a href="https://docs.google.com/presentation/d/1JP2n4kvD-3VVKwUudHBcMk53kGGc4f6MNF9kqJ4XAZI/edit?usp=sharing" target="_blank" class="pr-1">
                                <i class="fas fa-presentation fa-fw fa-lg align-middle"></i>
                        ...
                        <div class="row px-4">
                            ...
                            <div class="col-11">
                                Review <a href="{{ url($path.'/dashboard/curricula/elementary-school-curriculum#l4') }}" target="_blank">Grades 2-3</a>.
                            </div>
                            <div class="col-12">&nbsp;</div>

                    ...
                    <div class="card-body">
                        <div class="row px-4">
                            ...
                            <div class="col-lg-8 col-sm-12 text-justify">
                                <p><span style="color:#9acd57;font-weight:bold;font-size:16px">Sesión 6: Tratar de mantener nuestras lecciones tal cual no nos llevará lejos</span>
                                <br><span style="font-weight:light;font-size:12px">Grabado en jueves 6 de agosto a las 1e/12c/10p.</span>
                                <br><b>Reproducir nuestro plan de estudios original tal cual sólo nos guiará hasta cierto punto.</b> El programa original probablemente nos ayude a sobrevivir
                                la primera semana, pero definitivamente no es una solución a largo plazo a menos que le hagamos demasiadas modificaciones. Tomar las lecciones planeadas para
                                darse en persona y trasladarlas a una clase virtual sincrónica no tiene el mismo impacto en el aprendizaje. En lugar de intentar replicar su plan de estudios tal
                                cual, la mejor estrategia es modificarlo pensando en actividades que funcionen bien (¡o incluso funcionen mejor!) online ya que así logrará aumentar el compromiso
                                y el aprendizaje por parte de los participantes. Sin embargo, es normal que le lleve algún tiempo averiguar cómo modificar y adaptar bien su plan de estudios.</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row px-4">
                            ...
                            <div class="col-1"></div>
                            <div class="col-11">
                                <a href="{{ asset('unhushed_eesl_s-06_consejos-modificar-el-plan-de-estudios-presencial-para-el-aprendizaje-en-linea_v01.pdf') }}"
                                download="unhushed_eesl_s-06_consejos-modificar-el-plan-de-estudios-presencial-para-el-aprendizaje-en-linea_v01.pdf" class="px-1">
                                <i class="fas fa-file-download fa-fw fa-lg align-middle"></i>
                                Consejos para modificar: El plan de estudios presencial para el aprendizaje en linea</a>
                            </div>
                            <div class="col-12">&nbsp;</div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content text-center">
                <div class="modal-body">
                    ...
                    <iframe src="https://player.vimeo.com/video/451712544" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>

[![Rate your Sample](img/Ratesample.png)][ss1][![Yes](img/Thumbup.png)][ss2][![No](img/Thumbdown.png)][ss3]
...
* **OAuth2.0**  
    ...
    * Scope - Available scopes include: (Space delimited set of permissions that the application requests)
         ...
         ![APP screenshots](img/oauth2_scopes.png)
             
    * OAuth2.0 authorization flow  
    ![APP screenshots](img/oauth2flow.png)  
...
* **OpenID Connect**
    ...
    * Scope -  Available scopes include: (Space delimited set of permissions that the application requests)   
         ...
         ![APP screenshots](img/openIDConnect_scopes.png)
                       
    * OAuth2.0 authorization flow  
    ![APP screenshots](img/openIdConnectflow.png)  

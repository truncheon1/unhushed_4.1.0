    ...
    <div class="containerLMS">
        ...
        <div class="row mx-1">
            ...
            <div class="col-8">
                <hr>
                @if($package)
                <p class="sketchnote-square">Welcome to the UN|HUSHED {{$package->name}} page!</b></p>
                @else
        ...
        <div class="row mx-1">
            <div class="col-8">
                <p>We are so glad you’re here. You can use any of the resources here for FREE, as long as you credit UN|HUSHED.</p>
            </div>
            <div class="col-auto center float-end">
                @if($package)
                <img class="med" src="{{ url('uploads/products/'.($package->primary_image_path ?? $package->image)) }}" alt="{{$package->name}}">
                @endif
            </div>
        </div>
        ...
        <div class="row mx-1 anchor" id="l4">
            <div class="col-8" style="text-align: justify">
                ...
                <p>This file structure allows facilitators to view/print only the pages they need/want for specific sessions.
                    The files below are updated throughout the year as we make benefitial changes.
                    You can track those changes in the updated column. We also send out emails.</p>
                <p><b><u>Table structure:</u></b>
                    <br><b>CURRICULUM</b> this column (far left) shows the paid curriculum this free resource has been taken from.
                    <br><b>UNIT</b> this column shows the unit number each document/link belongs to.
                    <br><b>SESSION</b> this column shows the Session name each document/link belongs to.
            ...
            <div class="col-10">
                <table class="table table-hover border table-borderless table-striped" id="freeTable">
                    <thead>
                        <tr>
                            <th style="text-align:center; width: 11%;" class="align-middle bg-primary text-white">CURRICULUM</th>
                            <th style="text-align:center; width: 4%;" class="align-middle bg-primary text-white">UNIT</th>
                            <th style="text-align:center; width: 11%;" class="align-middle bg-primary text-white">SESSION</th>
                            <th style="text-align:center; width: 28%;"  class="align-middle bg-primary text-white"><i class="fa-solid fa-eye"></i>/<i class="fas fa-download"></i> DOCUMENT NAME</th>
                            <th style="text-align:center; width: 8%;" class="align-middle bg-primary text-white">MINUTES</th>
                            <th style="text-align:left; width: 28%;" class="align-middle bg-primary text-white">KEYWORDS</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <!-- unit -->
                            <td style="text-align:center; width: 11%;" class="align-middle">{{$u->name}}</td>
                            <!-- session -->
                            <td style="text-align:center; width: 4%;" class="align-middle">{{str_pad($s->number, 2, 0, STR_PAD_LEFT)}}</td>
                            <td style="text-align:center; width: 11%;" class="align-middle">{{$s->name}}</td>
                            <!-- document -->
                            <td style="text-align:left; width: 28%;" class="align-middle">
                                @empty($d->filenfo)

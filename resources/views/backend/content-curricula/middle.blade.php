...
<section>
    ...
    <div class="containerLMS">
                ...
                <table class="table table-hover border table-borderless" id="fullTable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align:left; width: 40%;" class="align-middle">Being packaged now... ETA for 2023 updates is October.</td>
        ...
        <div class="row mx-1 anchor" id="l4">
            ...
            <div class="col-12">&nbsp;</div>
            <div class="col-10">
                <table class="table table-hover border table-borderless table-striped" id="msTable">
                    <thead>
                        <tr>

        ...
        <div class="containerLMS">
            ...
            <div class="crumbBar">
                <div class="breadcrumbsBack">
                    ...
                    <span style="font-weight: bold;color:#9acd57">{{$activity->name}}</span>
                </div>
            </div>
            ...
            <div class="row my-3">
                ...
                <div class="col-2 center">
                    <img class="med" src="{{ url('uploads/products/'.$activity->image) }}">
                </div>
                <div class="col-5 pt-1">
                    <p class="sketchnote-square">{{$activity->name}}</b></p>
                    <hr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center; width: 5%;" class="align-middle">
                                    ...
                                    @elseif($f->source == 1)
                                        <a href="{{ url('uploads/products/'.$activity->reference_id.'/'.$f->resource) }}" target="_blank" rel="noopener noreferrer"><i class="fas fa-file-download fa-lg"></i></a>
                                    @endif
                                </td>

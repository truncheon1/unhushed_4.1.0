    ...
    <div class="containerLMS">
        ...
        <div class="row mx-1">
            ...
            <div class="col-4" style="text-align: justify">
                ...
                <br>• <a href="#l3">Curriculum by Grade</a>
        ...
        <div class="row mx-1 anchor" id="l1">
            <div class="col-8" style="text-align: justify">
                ...
                <p id="l2">After the Facilitator Guide, you have two choices when it comes to accessing the curricula:</p>
                    <ol>
                        <li><a href="#l3"><b>Curriculum by Grade:</b></a>
                            By updating your files once a year, downloading each grade as a cohesive unit. These large, grade-specific files are in the first set of links below. We gather everything new into these files in August and send out an email when it happens. Please note, you will still need to use the second method to download PowerPoints.
        ...
        <div class="row mx-1 anchor" id="l2">
            ...
            <div class="col-4">
                <table class="table border" id="fgTable">
                    <thead>
                        <tr>
        ...
        <div class="row mx-1 anchor" id="l3">
            <div class="col-8" style="text-align: justify">
                <hr>
                <p class="sketchnote-square">Curriculum by Grade</p>
                <p>These packages include the entire collection of pdfs by grade level. They are updated annually versus the more frequent updates we do in the individual files further below. Keep in mind that the Curriculum by Individual File will still be useful for you, as you will find links and digital resources there that cannot be included in a downloadable file.</p>
            </div>
            <div class="col-12">&nbsp;</div>
            <div class="col-4">
                <table class="table border" id="fullTable">
                    <thead>
                        <tr>
                            <th style="text-align:center; width: 60%;" class="align-middle bg-primary text-white">SESSIONS BY GRADE</th>
                            <th style="text-align:center; width: 40%;" class="align-middle bg-primary text-white">UPDATED</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="text-align:right; width: 20%;"   class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-0k_complete_v1.pdf') }}" target="_blank"><i class="fas fa-download"></i></a></td>
                            <td style="text-align:left; width: 40%;"    class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-0k_complete_v1.pdf') }}" target="_blank">Kindergarten</a></td>
                            <td style="text-align:center; width: 40%;"  class="align-middle">02/02/2022</td>
                        </tr>
                        <tr>
                            <td style="text-align:right; width: 20%;" class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-01_complete_v1.pdf') }}" target="_blank"><i class="fas fa-download"></i></a></td>
                            <td style="text-align:left; width: 40%;" class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-01_complete_v1.pdf') }}" target="_blank">1st grade</a></td>
                            <td style="text-align:center; width: 40%;" class="align-middle">03/07/2022</td>
                        </tr>
                        <tr>
                            <td style="text-align:right; width: 20%;" class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-02_complete_v2.pdf') }}" target="_blank"><i class="fas fa-download"></i></a></td>
                            <td style="text-align:left; width: 40%;" class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-02_complete_v2.pdf') }}" target="_blank">2nd grade</a></td>
                            <td style="text-align:center; width: 40%;" class="align-middle">01/12/2024</td>
                        </tr>
                        <tr>
                            <td style="text-align:right; width: 20%;" class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-03_complete_v1.pdf') }}" target="_blank"><i class="fas fa-download"></i></a></td>
                            <td style="text-align:left; width: 40%;" class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-03_complete_v1.pdf') }}" target="_blank">3rd Grade</a></td>
                            <td style="text-align:center; width: 40%;" class="align-middle">02/05/2022</td>
                        </tr>
                        <tr>
                            <td style="text-align:right; width: 20%;" class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-04_complete_v1.pdf') }}" target="_blank"><i class="fas fa-download"></i></a></td>
                            <td style="text-align:left; width: 40%;" class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-04_complete_v1.pdf') }}" target="_blank">4th Grade</a></td>
                            <td style="text-align:center; width: 40%;" class="align-middle">02/03/2022</td>
                        </tr>
                        <tr>
                            <td style="text-align:right; width: 20%;" class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-05_complete_v1.pdf') }}" target="_blank"><i class="fas fa-download"></i></a></td>
                            <td style="text-align:left; width: 40%;" class="align-middle"><a href="{{ asset('uploads/subscriptions/unhushed_e_u-05_complete_v1.pdf') }}" target="_blank">5th Grade</a></td>
                            <td style="text-align:center; width: 40%;" class="align-middle">02/07/2022</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row mx-1 anchor" id="l4">
            <div class="col-8" style="text-align: justify">
                ...
                <p><b><u>Table structure:</u></b>
                    <br><b>GRADE</b> this column (far left) shows the grade each document/link belong to.
                ...
                <p><b><u>Document structure:</u></b>
                    <br><b>Grade:</b> is a grouping of session.
            ...
            <div class="col-12">&nbsp;</div>
            <div class="col-10">
                <table class="table table-hover border table-borderless table-striped" id="esTable">
                    <thead>
                        <tr>
                            <th style="text-align:center; width: 2%;"   class="align-middle bg-primary text-white"></th>
                            <th style="text-align:center; width: 13%;"  class="align-middle bg-primary text-white">GRADE</th>
                            <th style="text-align:left; width: 6%;"     class="align-middle bg-primary text-white">SESSION</th>
                            ...
                            <th style="text-align:center; width: 26%;"  class="align-middle bg-primary text-white">KEYWORDS</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- unit -->
                            <td style="text-align:left; width: 13%;" class="align-middle">{!!$u->name!!}</td>
                            <!-- session -->

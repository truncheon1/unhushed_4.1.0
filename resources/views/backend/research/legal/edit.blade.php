        ...
        <div class="containerLMS">
            ...
            <div class="row">
                <div class="backendcrumbs">
                    ...
                    <a href="{{ url($section.'backend/pedagogy') }}">Pedagogy</a>
                </div>
            </div>
            ...
            <div class="row mt-2 mb-5">
                <div class="col-10">
                    <div class="card">
                        <div class="card-header">EDIT PEDAGOGICAL RESEARCH CITATION</div>
                        <div class="card-body">
                            <form action="{{url('backend/pedagogy')}}" method="POST" id="edit_entry" role="form" onsubmit="return editEntry()">

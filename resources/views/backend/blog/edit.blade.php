    ...
    <div class="containerBlog">
        ...
        <form action="{{url($path.'/backend/blog')}}" method="POST" id="add_post" role="form" onsubmit="return addPost()">
            ...
            <div class="row">
                <!-- LEFT POST -->
                <div class="col-10">
                    <input class="form-control shadow-none bg-transparent outline-none title" id="title" type="text" name="title" value="{{ $post->title }}">
                    <hr>
                    <textarea class="form-control shadow-none bg-transparent outline-none post teditor" id="content" name="content" value="{{ $post->content }}" style="min-height: 300px"></textarea>
                    <hr>
                </div>
                <!-- RIGHT SIDEBAR -->
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input id="slug" type="text" class="form-control" name="slug" value="{{ $post->slug }}" placeholder="url-slug">
                                        </div>

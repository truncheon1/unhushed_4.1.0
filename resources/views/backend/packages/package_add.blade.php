    ...
    <div class="containerLMS">
        ...
        <div class="crumbBar">
            <div class="breadcrumbsBack">
                ...
                <a href="{{ url($path.'/backend/packages') }}">Packages</a>
                <span style="font-weight: bold;color:#9acd57">Add Packages</span>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card" style="width: 50rem">
                    <div class="card-header container-fluid">
                        <div class="row">
                            <div class="col-md-10">ADD PACKAGES</div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ url($path.'/backend/packages') }}" method="POST" id="add_package" role="form" onsubmit="return addPackage()">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="ac_tags" type="text" class="form-control" name="ac_tags" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" id="ecurrencies" name="currency_id">
                                        @foreach(\App\Models\Currency::all() as $c)
                                            <option value="{{$c->id}}" >{{$c->name}} ({{$c->iso}})</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="sort" type="number" class="form-control" name="sort" value="{{\App\Models\Products::where('category', 1)->count()+1}}">
                                </div>
                            </div>
                            <div class="form-group row">

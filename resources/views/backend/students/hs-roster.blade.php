    ...
    <div class="containerLMS">
        ...
        <div class="crumbBar">
            <div class="breadcrumbsBack">
                ...
                <span style="font-weight: bold;color:#9acd57">HS class roster</span>
            </div>
        </div>
            ...
            <div class="col-10">
                <div class="card">
                    <div class="card-header container-fluid">
                        <div class="row">
                            <div class="col-12">High School Roster</div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="scrollB">
                            <table class="table table-striped" width="100%" id="stuTable" style="font-size:10px;">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="kid_name"       colspan="1" style="text-align:center">Student</th>
                                        <!--<th id="kid_email"       colspan="1" style="text-align:center">Email</th>-->
                                        <!--<th id="kid_phone"       colspan="1" style="text-align:center">Phone</th>-->
                                        ...
                                        <th id="parent1_name"   colspan="1" style="text-align:center">Parent 2</th>
                                        <th id="parent1_email"  colspan="1" style="text-align:center">Email</th>
                                        <th id="parent1_phone"  colspan="1" style="text-align:center">Phone</th>
                                        ...
                                        <td colspan="1" style="text-align:center">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item text-dark student-edit-link" rel="{{$detail['id']}}" href="{{url($path.'/backend/hs-roster/'.$detail['id'])}}" >Edit</a>
                                                    <a class="dropdown-item text-danger student-delete-link" rel="{{$detail['id']}}" href="{{ url($path.'/backend/hs-roster/'.$detail['id'])}}/delete">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <div class="modal fade" id="editStudent" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                @include('backend/students/hs-roster-edit')
            </div>
        </div>
    </div>

...
<div class="modal-body">
    <form action="{{url($path.'/backend/ms-roster')}}" method="POST" id="edit_student" role="form" onsubmit="return editStudent()" aria-label="edit_student">
        @if(count($details))
        ...
        <div class="form-group row">
            ...
            <div class="col-md-2">
                <input id="eage" type="number" class="form-control"  name="age" min="12" max="15">
            </div>
        </div>
        <div class="form-group row">
            <label for="egrade" class="col-2 col-form-label text-md-right">Grade</label>
            <div class="col-md-2">
                <input id="egrade" type="number" class="form-control" name="grade" min="7" max="8">
            </div>

...
<div class="modal-body">
    <form action="{{url($path.'/backend/standards/flag')}}" method="POST" id="edit_flag" role="form" onsubmit="return editFlag()">
                ...
                <div id='imageUpload' class='needsclick'>
                    <div class='upload needsclick text-center'>
                        <div class="dz-image">
                            ...
                            @else
                            <img class="tinyImg" src="{{ url('uploads/standards/'.$entry->flag) }}" alt="{{ $entry->flag}}"/></a>
                            @endempty
                        </div>
                        <br/>
                    </div>

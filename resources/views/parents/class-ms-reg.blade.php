        ...
        <div class="d-flex justify-content-center">
            <div class="row">
                ...
                <div class="col-auto px-1 mx-auto">
                    <p class="diazo">MS Registration</p>
                    <hr>
            ...
            <div class="row">
                <div class="col-12 pt-3">
                    <!-- register for classes -->
                        ...
                        <form method="POST" action="{{ url($path.'/ms-registration') }}" id="class-ms-reg-form">
                            @csrf
                            <p><b>Your info:</b></p>
                            ...
                            <div class="row form-group">
                                <div class="col-md-3 col-sm-6">
                                    ...
                                    <input type="number" name="age" id="age" class="form-control" placeholder="Age" min="12" max="15">
                                </div>
                                <div class="col-md-3 col-sm-6">
                                    <label for="grade" class="sr-only">Grade</label>
                                    <input type="number" name="grade" id="grade" class="form-control" placeholder="Grade" min="7" max="8">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control" name="gender_identity" id="gender_identity">
                                        <span style="color:grey;"><option value="0" selected>Select a gender identity</option></span>
...
<script>
    ...
    $(document).ready(function(){
        $("#continue").on('click', function(e){
            e.preventDefault();
            _url = $("#class-ms-reg-form").attr('action');
            _data = $("#class-ms-reg-form").serialize();
            $.ajax({
                url: _url,
                type: 'post',
                data: _data,

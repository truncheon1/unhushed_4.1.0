...
<section>
    ...
    <div class="container">
        <div class="d-flex justify-content-center">
            <div class="row">
                ...
                <div class="col-auto px-1 mx-auto">
                    <p class="diazo">HS Payment Options</p>
                    <hr>
        ...
        <div class="row justify-content-center pt-3">
            <div class="col-12 text-center pb-4">If you have not filled out the registration form <a href="{{ url($path.'/high-school-registration') }}">please do that here first.</a></div>
            <!-- pay for classes -->

...
<section>
    ...
    <div class="crumbBar">
        <div class="breadcrumbs">
            ...
            <span style="font-weight: bold;color:#9acd57">Reset Your Password</span>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card-body">
                ...
                <p class="diazo">Reset Your Password</p>
                <form method="POST" action="{{ url($path.'/password.update') }}">
                    @csrf
                    ...
                    <input name="reset" id="reset" class="btn btn-secondary" type="submit" value="UPDATE">
                </form>

...
<ul class="navbar-nav ml-auto mb-2 mb-md-0 text-center">
    ...
    <!-- SERVICES -->
    <li class="nav-item dropdown px-2">
        <a id="navbarService" href="{{ url($path.'/services') }}" aria-haspopup="true" aria-expanded="false">{{ __('SERVICES') }}</a>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarService">
                <a class="dropdown-item" href="{{ url($path.'/consulting') }}">CONSULTING</a>
                <a class="dropdown-item" href="{{ url($path.'/subscription-info') }}">CURRICULA</a>
                <a class="dropdown-item" href="{{ url($path.'/trainings') }}">TRAINING</a>
            </div>
    </li>
    <!-- FREE CONTENT -->
    <li class="nav-item dropdown px-2">

...
<section>
    <div class="containerHandbook" style="font-size:16px">
        <!-- Buy it -->
        <div class="row hnp justify-content-md-center">
            <div class="col-1 m-auto">
                <a href="{{ url($path.'/store/handbook-nursing-professionals') }}"><img src="{{url('uploads/products/'.($product->primary_image_path ?? $product->image))}}" alt="{{$product->name}}"></a>
            </div>
            <div class="col-md-5 col-sm-12 mx-auto desBox">
                ...
                <p style="font-size:20px; font-weight:bold; text-transform: uppercase;">AN INTRODUCTION TO SEXUALITY EDUCATION:
                    <br/><span style="color:black;">{{$product->name}}
                </p>
                <p><i>"This handbook is essential for public/community health nurses... The authors answer questions I didn’t even know I had."</i></p>
                <p>This manual provides nursing professionals, from emergency to family practice nurses, with the tools to combat problematic, inaccurate, and harmful sexuality information
                    that comes from families, classrooms, peers, partners, and the media.
                    It supports nurses as they consider their own biases, history, and knowledge base, and affirms that sexuality education is an integral piece to the nursing profession.</p>
                </div>
                <div class="row">
        ...
        <div class="row sections" style="padding-top:40px; padding-bottom:80px; color:black;">
            ...
            <div class="col-5 mx-auto">
                <p>The first section provides guidance on self-analysis for you as a nursing professional.
                    Understanding your personal perspective before you bring sexuality education into the clinical space is critical.</p>
            </div>
            <div class="col-12">
                <hr>
            </div>
            ...
            <div class="col-5 mx-auto">
                <p>The second section provides a broad overview on numerous topics related to sexuality that patients bring into the clinical setting.
            ...
            <div class="col-5 mx-auto">
                <p>The third section includes 25 handouts you can copy and use with patients along with guides and recommendations on how to use them.</p>
            </div>
            <div class="col-12">
                <hr>
            </div>
        ...
        <!-- Praise -->
        <div class="row h-grey" style="padding-top:50px; color:white;">
            <div class="col-auto mx-auto my-auto">
                <h3><i class="fa-solid fa-message-quote fa-fw"></i> PRAISE FOR THE HANDBOOK </h3>
            </div>
        </div>
        <div class="row h-grey" style="padding:25px; color:white;">
            <div class="col-6 mx-auto" style="text-align:justify;">
                <p><i class="fa-solid fa-quote-left"></i> If you have ever wanted to explain the difference between fadoodling and gobbledegoo, this is the book for you.
                    Rayne and Gustin have put together an exceptional new book about sexuality and so much more.
                    Although tailored for the nursing profession, this handbook is applicable to people in many different fields.
                    They have written a guide containing comprehensive definitions and terminology explanations, as well as a wealth of suggestions regarding conversations during patient interactions.
                    Perhaps most importantly, Rayne and Gustin have hit upon a beautifully inclusive framework for discussing gender and sexual orientation.
                    This is an excellent handbook for students, new nurses, and experienced practitioners. <i class="fa-solid fa-quote-right"></i></p>
                <p style="text-align:right;">– Christy Tashjian NP, CPM</p>
            </div>
        </div>
    <!-- Training -->
    <div class="row laptop" style="padding-top:50px; color:black;">
        ...
        <div class="row laptop justify-content-md-center" style="padding-bottom:25px; color:black;">
            ...
            <div class="col-3 bg-white rounded" style="color:#024318;">
                ...
                <script src="https://unhushed.activehosted.com/f/embed.php?id=19" charset="utf-8"></script>
            </div>
        </div>
        <!-- About UN|HUSHED -->
    ...
    <style>
        .hnp{
            ...
            background: url({{url('img/bgs/hnp.jpg')}}) no-repeat center center fixed;
            padding: 20px 50px;
        }
        .desBox{

...
class FlagController extends Controller
{
    ...
    public function update_flag(Request $request, $path = 'educators'){
        $entry = Dictionary::find($request->input('id'));
        if($request->input('file') && $request->input('file') !== $entry->flag){
